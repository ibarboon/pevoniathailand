...
class Products extends CI_Controller {
	...
	public function index() {
		...
		if (count($params['product_class']) > 0) {
			$params['current_view'] = 'products/'.$params['product_class']['product_class_alias_name'];
		...
		/* Product Type */
		$product_type = array('product_type_alias_name' => $this->uri->segment(3));
		...
		/* Product */
		$product = array('row_id' => $this->uri->segment(3));
